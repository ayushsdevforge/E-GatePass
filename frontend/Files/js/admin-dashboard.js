...
function showLoginModal() {
  if (loginModal) {
    ...
    console.log('Login modal displayed and activated');
  } else {
...
function hideLoginModal() {
  if (loginModal) {
    ...
    console.log('Login modal hidden and deactivated');
  }
}
...
function handleAdminLogin(e) {
  e.preventDefault();
  console.log('handleAdminLogin function called');
  ...
  if (!submitBtn) {
    ...
    showError(loginForm, 'Internal error: Submit button not found');
    return;
  }
  ...
  console.log('Making API call to:', `${API_URL}/admin/login`);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Set up close modal button event listener
